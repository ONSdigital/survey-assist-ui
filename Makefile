...
all-tests: ## Run all unit tests
	poetry run pytest --ignore=cicd --cov=utils --cov=survey_assist_ui --cov-report=term-missing --cov-fail-under=75

route-tests: ## Run the route tests
	poetry run pytest --ignore=cicd -m route --cov=utils --cov=survey_assist_ui --cov-report=term-missing --cov-fail-under=75

utils-tests: ## Run the route tests
	poetry run pytest --ignore=cicd -m utils --cov=utils --cov=survey_assist_ui --cov-report=term-missing --cov-fail-under=75
