...
with patch("survey_assist_utils.api_token.jwt_utils.generate_jwt", return_value="test-jwt"), \
     patch("utils.api_utils.get_verification_api_id_token", return_value="test-stub-token"):
    ...
    return {
        ...
        "questions": [
            ...
            },
            {
                ...
                "question_text": "Do you have any other feedback about this survey?",
                "question_description": "",
                "response_type": "textarea",
                "response_name": "other-feedback",
                "response_options": [],
                "guidance_enabled": True,
                "guidance_text": "<p>For instance did you see a long wait before a question was asked?</p><p>If you were asked a dynamic question was it a sensible and clear question to answer?</p><p>What are your thoughts about using AI as part of surveys?</p>",
                "justification_enabled": False,
                "justification_title": "Why we ask this question",
                "justification_text": "<p>Placeholder text</p>",
                "button_text": "Save and continue",
